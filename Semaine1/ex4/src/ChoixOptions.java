...
public class ChoixOptions {
    ...
    private List<Etudiant> prioriteEtudiant;
    ...
    public ChoixOptions(int nbEtudiantsParOption, String... nomsOption) {
        ...
        prioriteEtudiant = new ArrayList<>();
    ...
    public void ajouterPreferences(Etudiant etu, String choix1, String choix2,
                                   String choix3) {
        preferences.put(etu, new ArrayList<>());
    ...
    public void attribuerOptions() {
		prioriteEtudiant.sort(Comparator.comparing(Etudiant::getMoyenne).reversed());

		for (Etudiant etu : prioriteEtudiant) {
			var options = preferences.get(etu);
